...
namespace project.RayToFile{
public class Ray : MonoBehaviour
{
    // public LogTo logToFile;
    ...
    [SerializeField] private float visualizationScale = 0.1f; // Scale factor for visualizing the force
    ...
    void Update() {
        ...
        float distanceMoved = Vector3.Distance(body.position, lastPosition);
    ...
    // }
    public static void ForDebug(Vector3 pos, Vector3 direction, Color color, float arrowHeadLength = 10.0f, float arrowHeadAngle = 60.0f)
    {
